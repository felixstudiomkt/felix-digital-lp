...
export default function ContatoPage() {
  return (
    <SiteShell><main>
      <section className="form-page flow-grid"><div className="container form-page-head"><Eyebrow>INICIAR PROJETO</Eyebrow><h1>Conte o que precisa funcionar melhor.</h1><p>Pode ser um site que não converte, um processo preso em planilhas, um atendimento lento ou uma operação difícil de acompanhar. Começamos entendendo o cenário.</p></div></section>
